########################################################################
#
# remove-empty-lines is free software; you can redistribute it and/or modify
...
########################################################################
#
#  Project      :  File Preprocessor - remove-empty-lines module
#  Filename     :  remove-empty-lines.pm
...
# usage: filepp -m remove-empty-lines.pm <files>
########################################################################
...
Filepp::AddProcessor("RemoveEmptyLines::RemoveEmptyLines");
